...
def main_train_feature_state(patient, data_list, times_list, metadata_list, vigilance_list, SPH, SOP_list):
    ...
    # --- Save models ---
    path = '../Results/Models/Feature_state'
        ...
        for C_i in C:
            ...
            for fold_i in range(n_folds): 
                for classifier_i in range(n_classifiers):
                    ...
                    selector.scores_[-1] = np.inf # force to use vigilance feature by assigning a high score
